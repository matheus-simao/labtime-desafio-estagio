...
Os observadores concretos ficam em `sistema.sistemas_bordo`. Repare que este
modulo nao importa nada de la, nem sequer a camada de apresentacao: ele
depende apenas da biblioteca padrao.
"""
